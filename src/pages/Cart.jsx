...
export default function Cart() {
  ...
  return (
    <div className="min-h-screen py-6 px-4 font-sans bg-[#283618]  border-b-2 border-white">
      <div className="max-w-7xl mx-auto">
        {/* Header Section */}
        <h1 className="text-2xl md:text-3xl font-bold  mb-4 text-center font-serif text-white">
          Your Cart
        </h1>
        <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              {filteredCart.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row items-center justify-between border border-gray-300 rounded-lg p-4 bg-accent shadow-sm"
                >
            ...
            {/* Price Details */}
            <div className="border border-gray-300 rounded-lg p-6 bg-accent shadow-sm">
