...
export default function Wishlist() {
  ...
  return (
    <section className="min-h-screen py-4 px-3 font-sans  border-b-2 border-white bg-[#283618]">
        ...
        {wishlist.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-3 rounded-3xl">
            {wishlist.map((product) => (
              <div
                key={product.id}
                className="bg-accent min-w-32 shadow-md rounded-3xl p-4 hover:shadow-2xl hover:scale-105 border-2 border-orange-100 hover:border-orange-400 transition-transform h-auto relative cursor-pointer"
