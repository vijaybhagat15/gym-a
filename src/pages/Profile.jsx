...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen  font-sans flex items-center justify-center py-10  border-b-2 border-white bg-[#283618]">
      <div className="max-w-5xl w-full bg-gray-200 shadow-xl rounded-3xl overflow-hidden border-8 border-gray-200 sm:flex">
        <div className="sm:w-1/3 bg-accent flex items-center justify-center rounded-3xl">
        ...
        <div className="sm:w-2/3 p-6 max-w-3xl text-gray-700">
          {editable ? (
              ...
              {['username', 'email', 'contactNumber', 'address'].map((field) => (
                <div key={field}>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none"
                  />
                </div>
              ))}
              <div>
            ...
            <>
              <h2 className="text-2xl font-semibold mb-4 text-black font-serif">
                Account Details
              </h2>
              {['username', 'email', 'contactNumber', 'address'].map((field) => (
                <div key={field} className="mb-4">
                  ...
                  <p className="bg-gray-300 px-4 py-2 rounded-lg">{formData[field] || 'N/A'}</p>
                </div>
              ))}
              <button
