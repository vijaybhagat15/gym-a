...
export default function Contact() {
  return (
    ...
    <img
      ...
      alt="Login"
      className="max-w-md max-h-md bg- rounded-3xl"
    />
  </div>
    <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center p-6 font-sans ">
      <div className="w-full lg:w-1/2 max-w-md mb-8 lg:mb-0 lg:mr-12">
        <div className="bg-accent shadow-lg rounded-lg p-8 mb-6 border-2 border-gray-200 hover:border-orange-500 transition-colors">
        ...
        <div className="bg-accent shadow-lg rounded-lg p-8 border-2 border-gray-200 hover:border-orange-500 transition-colors">
          <div className="flex items-center mb-4">
      ...
      <div className="w-full lg:w-1/2 max-w-md">
        <div className="bg-accent shadow-xl rounded-lg p-8 border-2 border-gray-200 hover:border-orange-500 transition-colors">
