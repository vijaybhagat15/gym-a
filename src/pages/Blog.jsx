...
export default function Blog() {
  return (
    <div className="bg-[#283618]  text-white font-sans  border-b-2 border-white">
      {/* Content */}
      <div className=" z-10 container mx-auto py-12 px-6 bg-gradient-to-br to-gray-100 bg-opacity-70">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {blogPosts.map((post) => (
            <div
              key={post.id}
              className="bg-accent min-w-40 shadow-md rounded-3xl p-2 hover:shadow-2xl hover:scale-105 border-2 border-orange-100  transition-transform h-auto"
            >
              <div className="p-6">
                {/* Profile Section */}
