...
export default function ProductDetailsWithWishlist() {
  ...
  return (
    <div className=" mx-auto py-10 px-4 sm:px-8 lg:px-12 font-sans  border-b-2 border-white bg-[#283618]">
      <div className="flex flex-col lg:flex-row lg:items-start gap-12 lg:gap-16 rounded-3xl shadow-lg p-6 sm:p-8 bg-accent">
        {/* Product Image */}
