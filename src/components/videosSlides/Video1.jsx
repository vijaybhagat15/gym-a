    ...
    <div className="sm:bg-gradient-to-bl bg-gradient-to-r from-[#283618] to-[#f4d35e] h-screen grid grid-cols-1 md:grid-cols-2 items-center font-sans px-2 md:px-4">
      ...
      >
        ...
        >
          <motion.video
            ref={videoRef1}
            src="https://videos.pexels.com/video-files/20559800/20559800-hd_1080_1922_60fps.mp4" // Replace with your video URL
      ...
      >
        <div className="text-white px-8">
          ...
          >
            Take your strength to the next level with our Deadlift Training! Discover expert tips, techniques, and the best supplements for powerful gains.
          </motion.p>
          <motion.div
